...
import { Zap, PanelLeftClose, PanelLeftOpen, RefreshCw, Sun, Moon, Gamepad2, Bot, Film, Tv2 } from 'lucide-react';
      ...
      <div className={`transition-all duration-300 ease-in-out bg-card border-r border-border flex flex-col flex-shrink-0 ${isSidebarOpen ? 'w-64 p-4' : 'w-0 md:w-20 p-0 md:p-2 items-center'}`}>
        ...
        <div className="mt-auto pt-4 border-t border-border flex flex-col gap-2">
          <button 
            ...
            className={`w-full p-3 rounded-lg text-card-foreground/80 hover:bg-background transition-colors flex items-center gap-3 ${isSidebarOpen && 'justify-center'}`}
          >
